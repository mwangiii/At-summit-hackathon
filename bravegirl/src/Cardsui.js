    ...
    <div className='cardsui'>
      ...
      <div className='col' id='col-2'>
        <Card
          ...
          span='Brave Girls envisions a world where every girl, regardless of circumstance, can spread her wings, rise above challenges, and become a beacon of inspiration for others.We strive to create a better tomorrow.'
        />
      </div>
